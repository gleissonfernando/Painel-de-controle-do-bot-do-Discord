...
import { fetchGuildDetails, fetchGuildChannels, fetchGuildRoles } from "./discord";

describe("Discord API Integration", () => {
  const guildId = process.env.VITE_DISCORD_GUILD_ID || "1474167739391410320";

  it("should fetch guild details from Discord API", async () => {
  ...
  it("should fetch guild channels from Discord API", async () => {
  ...
  it("should fetch guild roles from Discord API", async () => {
